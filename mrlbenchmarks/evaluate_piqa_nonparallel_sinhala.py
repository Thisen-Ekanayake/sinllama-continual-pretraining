...
Few-shot exemplars are a BALANCED set (4 each of 1/2 for the default 8-shot)
held out from the test set. base/CPT/llama scored raw; the instruct model
(--alpaca-models) is re-wrapped in the Alpaca template. Runs on GPU (bf16) by
default; --device cpu (float32) as a fallback.
"""
